...
/*
 * Get openam code and call the normal login page
...
if (empty($code)) {
    throw new moodle_exception('openam_failure');
}
...
$url = new moodle_url($loginurl, array('code' => $code, 'authprovider' => 'openam'));
redirect($url);
?>
