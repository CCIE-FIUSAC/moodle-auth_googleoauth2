...
$string['auth_openamclientid'] = 'Es el identificador del cliente Moodle.';
$string['auth_openamclientid_key'] = 'Id Cliente OpenAM';
$string['auth_openamclientsecret'] = 'Ver arriba.';
$string['auth_openamclientsecret_key'] = 'Secreto App OpenAM';
$string['auth_openamscope'] = 'Son los datos solicitados al servidor de OpenAM. ej: givenname inetuserstatus sn mail cn';
